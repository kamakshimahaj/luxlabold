...
<textarea class="form-control" id="txtname3" name="txtname3" rows="10" placeholder="ENTER PRODUCT DETAILS" ></textarea>
</div>
...
<select  class="form-control border"  name="ccltype" id="ccltype">
...
<input type="radio" class="form-check-input"  class="form-control"  name="rbact" id="rbact" value="1">Yes</label>
</div>
<div class="form-check">
<label class="form-check-label">
