...
<?php
    ...
    include_once 'function.php';
     ...
     $sqllogin="SELECT * FROM tab_bulkbuyer where login_id='".$id."' and password='".$pass."'";
            ...
            if($rowcount==1)
            {
                if($row=mysqli_fetch_array($result))
                {
                    ...
                    $_SESSION['active']=$row['active'];
                     header('location:bulkbuyer_welcome.php');
                }
            }
            else
            {
...
<div class="container">
  ...
  <div class="card-body" style="background-color:whitesmoke ">
   ...
   style="cursor: pointer; margin-left: -30px; z-index: 100;"></i>
				...
				<center><a href="bulkbuyer_forgetpass.php">Forgot password?</a></center>
				<div>
			   <br>Dont have an account?<a href="bulkbuyer_signup.php">
				Sign up</a></div>
				<br>
