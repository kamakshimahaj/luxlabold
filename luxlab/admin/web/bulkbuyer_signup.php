...
<title>Bulkbuyer Creation</title>
...
$varmob=$_POST['num'];
$dt=date("y-m-d h:i:s");
$sqlchk="SELECT * FROM tab_bulkbuyer where login_id='".$varlid."'";
          ...
          if($rowcount==0)
            {
                ...
                echo $sql="INSERT INTO tab_bulkbuyer(name,login_id,password,image, mob_no,active,creation_date)	
				...
				$obj1->email_send($varlid," Bulkbuyer Login Password ",$msg);
...
<h1>Bulkbuyer Login</h1>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" >
<div class="form-group">
<label for="txtname">Bulkbuyer Name</label>
<input type="text" class="form-control" id="txtname" name="txtname" placeholder="Enter bulkbuyer Name" required="required">
</div>
...
<a href="bulkbuyer_signin.php"> Sign in</a> </div>
</div>
<div class="row">
<br>
</div>
