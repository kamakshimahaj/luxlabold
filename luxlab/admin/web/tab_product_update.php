...
<textarea class="form-control" id="txtname3" name="txtname1" rows="3" placeholder="ENTER PRODUCT DETAILS"   ><?php echo $varpd;?></textarea>
</div>
...
<select multiple class="form-select"  id="ccltype"   name="ccltype" >
