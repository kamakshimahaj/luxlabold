            ...
            <div class="col-12 text-center">
                <div class="page-title-content">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="single-product.php" class="active">Crown Summit Backpack</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 mt-5 mt-lg-0">
                            <div class="product-details">
                                ...
                                <a href="single-product.php" target="_blank" class="btn btn-add-to-cart mt-5"><i
                                        class="fa fa-shopping-cart"></i> Buy Now</a>
                                <a href="single-product.php" target="_blank" class="btn btn-add-to-cart mt-5 ml-5"><i
                                        class="fa fa-shopping-bag"></i> Add Cart</a>
                            </div>
                        </div>
                        <!-- Product Details End -->
                    </div>
