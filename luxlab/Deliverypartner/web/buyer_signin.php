...
<?php
    ...
    include_once 'function.php';
     ...
     $sqllogin="SELECT * FROM tab_buyer where login_id='".$id."' and password='".$pass."'";
...
<div class="container">
  ...
  <div class="card-body" style="background-color:whitesmoke ">
   ...
   style="cursor: pointer; margin-left: -30px; z-index: 100;"></i>
				...
				<center><a href="buyer_forgetpass.php">Forgot password?</a></center>
				<div>
			   <br>Dont have an account?<a href="buyer_signup.php">
				Sign up</a></div>
				<br>
