...
<div class="row mb-2">
	...
	<input type="text" class="form-control" id="txtres" name="txtres"
	 placeholder="Result of Calculation" readonly value="<?php echo $res; ?>"><!--readonly is used so that result value could not be altered unless there is change in value-->
	</div> 
