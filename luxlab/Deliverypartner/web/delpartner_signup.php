          ...
          if($rowcount==0)
            {
                ...
                echo $sql="INSERT INTO tab_deliverypartner(name,login_id,password,image, mob_no,active,creation_date)	
				...
				$obj1->email_send($varlid," deliverpartner Login Password ",$msg);
...
<label for="txtname">Dlivery Partner Name</label>
<input type="text" class="form-control" id="txtname" name="txtname" placeholder="Enter partner Name" required="required">
</div>
...
<a href="delpartner_signin.php"> Sign in</a> </div>
</div>
<div class="row">
<br>
</div>
