...
$varmob=$_POST['num'];
$dt=date("y-m-d h:i:s");
$sqlchk="SELECT * FROM tab_buyer where login_id='".$varlid."'";
          ...
          if($rowcount==0)
            {
                ...
                echo $sql="INSERT INTO tab_buyer(name,login_id,password,image,mob_no,active,creation_date)	
				...
				$obj1->email_send($varlid," Buyer Login Password ",$msg);
...
<label for="txtname">Buyer Name</label>
<input type="text" class="form-control" id="txtname" name="txtname" placeholder="Enter buyer Name" required="required">
</div>
...
<a href="buyer_signin.php"> Sign in</a> </div>
</div>
<div class="row">
<br>
</div>
