...
if (isset($_POST['btn']))
    { 
        ...
        {
 $sql= "SELECT * FROM tab_admin where login_id='".$_SESSION['aid']."'";
    ...
    $sqpupdate="update tab_admin set password='$newpass' where login_id='".$_SESSION['aid']."'";
            ...
            <div class="col-sm-6 ">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-8 ">
                            <h1 class="required">Change Password</h1>
                        </div>
                    </div>
                    <div class="form-group">
