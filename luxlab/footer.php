                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            <figure class="callto-thumb">
                                <img src="assets/img/money-back.png" alt="WorldWide Shipping"/>
                            </figure>
                            <div class="callto-info">
                                <h2>Free Shipping </h2>
                                <p>On order over &#8377;5000 - 7 days a week</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            ...
                            <div class="callto-info">
                                ...
                                <p>Call us 24/7 at 6283087875</p>
                            </div>
                        </div>
                        <!-- Single Call-to Action End -->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="single-callto-action d-flex">
                            ...
                            <div class="callto-info">
                                <h2>Easy Access</h2>
                                <p>Ease in purchasing with our wide range of products</p>
                            </div>
                        </div>
                        <!-- Single Call-to Action End -->
                    </div>
            ...
            <div class="followup-wrapper">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="follow-content-wrap row">
                            <div class="col-lg-4 mx-auto mb-5 mb-lg-0">
                                <a href="index.php" class="logo"><img src="assets\img\logo-black.png" alt="logo"/></a>
                            ...
                            <div class="col-lg-4 mx-auto mb-5 mb-lg-0">
                                ...
                                <li><a href="exchangepolicy.php">Exchange Policy</a></li>
                                <li><a href="refundpolicy.php"> Refund Policy</a></li>
                                <li><a href="admin/index.php"> Admin Login</a></li>
                                <li><a href="Deliverypartner/index.php"> Delivery Partner Login</a></li>
                                </ul>
                            </div>
                            <div class="col-lg-4 footer-social-icons">
                                <h3 class="text-white">Follow Us on:</h3><br>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="copyright-text">
                        <p><a target="_blank" href="index.php">Copyright 2024 © Luxaurajewels.com</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Chatbot Integration -->
<?php include_once 'chatbot-widget.php'; ?>
